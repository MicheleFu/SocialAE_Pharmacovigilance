...
# e crea una tabella per ogni EA, riportante i farmaci con ROR significativo
# insieme ai rispettivi ROR, IC, F_EA e F_nEA.
...
# Rda Needed ------------------------------------------------------------------
load("~/Desktop/PhV_of_Social_Impact/Rda/df_unico.Rda")
load("~/Desktop/PhV_of_Social_Impact/Rda/EA.Rda")
load("~/Desktop/PhV_of_Social_Impact/Rda/F.Rda")

# Disproportionality Analysis (tabelle EA)--------------------------------------------------

DA <- function(dataframe, farmaci) {
  # Crea le tabelle riportanti i ROR significativi per ogni EA
  #
  # Args:
  ...
  #
  # Returns:
  #   una tabella per ogni EA, riportante i farmaci con ROR significativo
  #   insieme ai rispettivi ROR, IC, F_EA e F_nEA.
  #
  for (e in EAlist) {
